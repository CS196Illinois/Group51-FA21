...
class AudioRecorder: NSObject, ObservableObject {
    ...
    func fetchRecordings() {
        //empty documents list to not display multiple times
    ...
    //accepts an array of urls to delete and deletes them
