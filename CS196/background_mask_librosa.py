...
sound = pydub.AudioSegment.from_file("input/OjuSpeaking.m4a")
sound.export("input/OjuSpeaking.wav", format="wav")

# audio is a series of floating points
audio, sampling_rate = librosa.load('input/OjuSpeaking.wav', duration=120)
